...
## Possível evolução com CRUD

Na próxima etapa, a interface pode evoluir para um sistema com CRUD para:

- cadastrar, listar, editar e excluir sabores;
- cadastrar, listar, editar e excluir adicionais;
- gerenciar preços;
- cadastrar combos;
...
- `script.js`: interações do menu e do montador de pedido.
- `img/`: imagens utilizadas na landing page.
